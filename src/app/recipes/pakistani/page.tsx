...
import { getPakistaniRecipes } from "@/services/api.services";
import { IRecipe } from "@/models/recipe";

const PakistaniRecipesPage = async () => {
    const recipes: IRecipe[] = await getPakistaniRecipes();

    return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-center p-6">
            <h1 className="text-3xl font-bold text-orange-500 mb-4">Pakistani Recipes</h1>
...
export default PakistaniRecipesPage;
